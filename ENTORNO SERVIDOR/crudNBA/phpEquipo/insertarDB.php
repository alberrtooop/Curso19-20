...
if (isset($_POST['Nombre']) && !empty($_POST['Nombre']) &&
    ...
    if ($conexion->insertarEquipo($Nombre, $Ciudad, $Conferencia, $Division) == false) {
        echo "<img class='imgFo' src='../Imagen/404.png' alt=''/>";
    } else {
        $conexion->insertarEquipo($Nombre, $Ciudad, $Conferencia, $Division);
        echo "<h1>&Uacute;ltimo Registro insertado</h1><br/>";
