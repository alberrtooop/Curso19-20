$(document).ready(function () {
    ...
    function coincidePassword() {
        ...
        if (valor1 == valor2) {
            $(document).ready(function () {
                $('#contrasena').css('border', '1px solid #CED5D7');
                $('#contrasena').css('box-shadow', '0 0 0 3px #EEF5F7');
                $('#contrasenaconfirmar').css('border', '1px solid #CED5D7');
                $('#contrasenaconfirmar').css('box-shadow', '0 0 0 3px #EEF5F7');
            });
        } else if (valor1 != "") {
            $(document).ready(function () {
